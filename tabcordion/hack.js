...
(function() {
  ...
  console.log('%c TabCordion v1.8 (Interim Edition) in use. ', 'background: #6e00ee; color: #fff');
  ...
  function toggleTabCordion(thisButton, oldTab, thisButtonIndex) {
    ...
    if (!thisButton.classList.contains(tabCordionActiveState)) {
      ...
      activeState.forEach(function(activeButton){
        ...
        if (activeButton.hasAttribute("data-aria-selected")) {
          ...
          activeButton.setAttribute("data-aria-selected", "false");
          activeButton.setAttribute("tabindex", "-1");
          activeButton.classList.remove(tabCordionActiveState);
          activeButton.nextElementSibling.classList.remove(tabCordionExpandedState);
          activeButton.nextElementSibling.removeAttribute("tabindex");
          thisButton.setAttribute("data-aria-selected", "true");
     ...
     tabCordions.forEach(function(tabCordion, i){
        ...
        tabListButton.forEach(function(button, j){
          ...
          button.addEventListener("keydown", function (e) {
            ...
            if (this.hasAttribute("data-aria-selected")) {
        ...
        if (tabListBreakPoints[i].matches) {
          ...
          tabCordion.setAttribute("data-role", "tablist");

          if(tabVertical !== null) {

            // Indicate orientation

            tabCordion.setAttribute("data-aria-orientation", "vertical");
          ...
          tabListButton.forEach(function(button, j){
            ...
            button.setAttribute("data-aria-selected", "false");
            ...
            if(Number(tabListItemCount) === Number(tabPanelSelected)) {
              ...
              button.setAttribute("data-aria-selected", "true");
          ...
          tabListPanel.forEach(function(panel, j){
            ...
            panel.setAttribute("data-role", "tabpanel");
          ...
          tabCordion.removeAttribute("data-role");

          if(tabVertical !== null) {

            // Remove orientation

            tabCordion.removeAttribute("data-aria-orientation");
          ...
          tabListButton.forEach(function(button, j){
            ...
            button.removeAttribute("data-aria-selected");
          ...
          tabListPanel.forEach(function(panel){
            ...
            panel.removeAttribute("data-role");
