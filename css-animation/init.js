...
(function () {
	...
	$cssAnimationHeader.append("<button class='btn css-animation__button' aria-expanded='false'>View CSS</button><div aria-label='CSS' class='css-animation__code highlight' role='region'><pre><code class='language-css slideLeft'></code></pre></div>");
